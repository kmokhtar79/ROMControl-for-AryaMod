...
public class MainViewActivity extends AppCompatActivity
    ...
    public List<NavItem> getMenu() {
        List<com.aryamod.romcontrol.NavItem> items = new ArrayList<>();
        ...
        * 8. You need to add same items to the int array in NavigationDrawerFragment, which has the same method*/
        ...
        for (int i = 0; i < mTitles.length && i < mIcons.length; i++) {
            com.aryamod.romcontrol.NavItem current = new com.aryamod.romcontrol.NavItem();
        ...
        * See more detailed instructions on the thread or in annotations to the previous method*/
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new NotiPanelFragment()).commitAllowingStateLoss();
                break;
            case 2:
            ...
            case 5:
                ...
                break;
            case 6:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new SoundFragment()).commitAllowingStateLoss();
                break;
            case 7:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new OtherModsFragment()).commitAllowingStateLoss();
                break;
            case 8:
